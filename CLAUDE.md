...
**Estado: implementada y en piloto** (esquema en `SchemaVersion`, hoy `0.47.0` —
...
**`0081_…`** hasta el 2026-08-28, cuando el real era **0.46.0** y **`0084_…`** — y ese mismo día
volvió a moverse a **0.47.0** / **`0085_…`** con la Ola A: mismo antídoto que aplicó
`wapp-cloudlink/CLAUDE.md` con su tag.)
